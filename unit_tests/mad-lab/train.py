...
def get_args():
    ...
    parser.add_argument('--num-tokens-to-copy', type=int, default=16, help='number of tokens to copy in selective-copying')
    ...
    parser.add_argument('--save-checkpoints', action=argparse.BooleanOptionalAction, default=False, help='if True, final and best model checkpoints are saved in the log directory')
