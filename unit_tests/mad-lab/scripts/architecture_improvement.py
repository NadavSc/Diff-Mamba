...
def get_args():
    ...
    parser.add_argument('--save-checkpoints', action=argparse.BooleanOptionalAction, default=False, help='whether to save final and best model checkpoints of each run')
...
def run_sweep(
    ...
    for model_label, model_layers in {
        ...
        # DiffMamba2 base model
        'DiffMamba2': ['diffmamba2', 'diffmamba2', 'diffmamba2', 'diffmamba2']
    }.items():
        ...
        def make_model_fn(
            ...
            for layer_idx, layer_config in enumerate(layer_configs):
                ...
                layer_config['layer_idx'] = layer_idx + 1
        ...
        # model_mad_scores['total'] = model_mad_scores['test_acc'].mean()
        model_mad_scores['total'] = model_mad_scores.mean()
        model_mad_scores['model'] = model_label
        # model_mad_scores = model_mad_scores.reset_index()
        # mad_scores.append(model_mad_scores)
