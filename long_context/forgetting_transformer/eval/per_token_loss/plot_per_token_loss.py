...
if __name__ == "__main__":
    ...
    parser.add_argument("--result_dir", type=str, default='forgetting-transformer/eval/per_token_loss/results')
    parser.add_argument("--figure_dir", type=str, default='forgetting-transformer/eval/per_token_loss/results')
    args = parser.parse_args()

    MODELS = [
        "mamba2-370m-pretrain-pile-1Mbatch",
        "diffmamba2-370m-pretrain-pile-1MBatch-24inout",
    ]
    ...
    MODEL_TO_LABEL = {
        "mamba2-370m-pretrain-pile-1Mbatch": "Mamba",
        "diffmamba2-370m-pretrain-pile-1MBatch-24inout": "Diff-Mamba",
    }
    MODEL_TO_COLOR = {
        "mamba2-370m-pretrain-pile-1Mbatch": "C0",
        "diffmamba2-370m-pretrain-pile-1MBatch-24inout": "C2",
    }
    ...
    print(f"Figure saved into {pdf_path}")
