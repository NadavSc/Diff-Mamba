...
MODEL_NAME="diffmamba2-370m-needle-finetune-seed0"
MODEL_PATH="../../../outputs/diffmamba2-370m-needle-finetune"
TOKENIZER_PATH="../../../outputs/diffmamba2-370m-needle-finetune"
